...
public class UserRepository : IUserRepository
{
    ...
    public async Task<Actor?> GetActorByIdAsync(string actorId)
    {
        ...
        var actor = await _mongoDbRepository.GetSpecificItem(filterActor, DatabaseLocations.Actors.Database, DatabaseLocations.Actors.Collection);
    ...
    {
        var actors = await _mongoDbRepository.GetAll<Actor>(DatabaseLocations.Actors.Database, DatabaseLocations.Actors.Collection);
    ...
    public async Task<ActorSecrets?> GetActorSecretsAsync(string actorId)
    {
        ...
        var actorSecrets = await _mongoDbRepository.GetSpecificItem(filterActor, DatabaseLocations.ActorSecrets.Database, DatabaseLocations.ActorSecrets.Collection);
        return actorSecrets;
    }
}