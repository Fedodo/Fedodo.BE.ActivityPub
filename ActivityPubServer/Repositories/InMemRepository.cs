    ...
    public Actor GetActor(Guid actorId)
    {
        List<Actor> actors = new()
        {
            ...
            new Actor
            {
                ...
                Id = new Uri("https://ap.lna-dev.net/actor/018E5972-9C9F-417B-A0CF-E8290904F737"),
                Type = "Person",
            ...
            new Webfinger
            {
                ...
                Links = new[]
                {
                    new Link
                    {
                        Rel = "self",
                        Type = "application/activity+json",
                        Href = new Uri("https://ap.lna-dev.net/actor/018E5972-9C9F-417B-A0CF-E8290904F737")
                    }
                }
            }
        };
